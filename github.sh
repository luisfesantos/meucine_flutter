...
export name='Luis Felipe'
export email="luis.santos585@etec.sp.gov.br"
export repositorio="https://github.com/luisfesantos/meucine_flutter.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="MeuCine-$(date +%d%m%Y)"
...
git commit -am "Código do dia: $(date +%d%m%Y)"
